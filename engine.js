 ...
 */
try {
  document.getElementById("_fullName").innerText =
    typeof fullNameString !== "undefined" ? fullNameString : fullName;
} catch (error) {
  console.error(error);
}
try {
  ...
  const placeholderAvatar =
    "https://user-images.githubusercontent.com/8784343/133905455-8b304ea7-815e-4729-af9c-c0252df29e52.jpg";
  document.getElementById("_image").src = placeholderAvatar;
}
try {
  document.getElementById("_dob").innerText =
    typeof yearOfBirthString !== "undefined" ? yearOfBirthString : yearOfBirth;
} catch (error) {
  console.error(error);
}
try {
  document.getElementById("_hobby").innerText =
    typeof hobbyString !== "undefined" ? hobbyString : hobby;
} catch (error) {
  console.error(error);
}
try {
  document.getElementById(
    "_funFact"
  ).innerText = `Did you know that ${funFact}`;
} catch (error) {
  console.error(error);
}
...
try {
  ...
  try {
    image =
      "https://user-images.githubusercontent.com/8784343/133905760-4e6adc27-e3ff-40ac-9999-f0c419b14311.png";
    setTimeout(function () {
      document.getElementById("_image").src = image;
      console.error(
        "Hidden task!: Change the image to be constant not variable"
      );
    }, 10000);
  } catch (error) {
